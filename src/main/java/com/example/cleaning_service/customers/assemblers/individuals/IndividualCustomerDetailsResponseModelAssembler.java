...
@Component
public class IndividualCustomerDetailsResponseModelAssembler extends RepresentationModelAssemblerSupport<IndividualCustomer, IndividualCustomerDetailsResponseModel> {
    private final IndividualCustomerMapper individualCustomerMapper;

    public IndividualCustomerDetailsResponseModelAssembler(IndividualCustomerMapper individualCustomerMapper) {
